...
> 本文件保留为 2026-08-21 阶段性交付记录。项目当前状态、完整架构、模块设计、测试数据和扩展路线统一以 [PaperAgent 项目完整说明书](PAPERAGENT_PROJECT_MANUAL.md) 为准。
...
在个人论文库打开 GraphRAG，点击“基于此论文提问”，再输入“阅读这篇论文的架构图……”。页面显示当前论文绑定，后端通过 document_id 安全解析 PDF，让系统自动选页并展示视觉任务、页面选择、结构化契约和 Grounding，无需填写服务器文件路径。
