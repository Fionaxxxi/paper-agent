...
def test_replan_outperforms_plain_retry_and_meets_acceptance_gate():
    ...
    assert summary["candidate_oracle_query_match_rate_pct"] == 100.0
    assert summary["baseline_oracle_query_match_rate_pct"] < summary["candidate_oracle_query_match_rate_pct"]
